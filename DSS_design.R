...
TreatmenDMR<-callDMR(DMLtest.Treatment, p.threshold=0.05)

write.table(TreatmenDMR, file= "normalised_dmrs.tsv", append = FALSE, sep = "\t", dec = ".", quote = FALSE, row.names = FALSE, col.names = TRUE)
